  ...
  app: {
    head: {
      ...
      meta: [
        ...
        {
          name: "description",
          content: "TurboAnime - A streaming service for weebo...",
        },
        {
          name: "keywords",
          content:
            "TurboAnime, turbo, turbomods, anime streaming site, anime, free anime",
        },
        { property: "og:type", content: "website" },
        { property: "og:url", content: "/" },
        { property: "og:title", content: "Home - TurboAnime" },
        {
        ...
        { property: "twitter:title", content: "Home - TurboAnime" },
        {
